...
<div class="modal fade" id="modal-cr_submenu" data-backdrop="static" 
tabindex="-1" role="dialog" aria-labelledby="modal-cr_submenuLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header bg-info">
        <h5 class="modal-title" id="modal-cr_submenuLabel">
          Tambah Data Submenu
        </h5>
